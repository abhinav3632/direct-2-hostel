...
export const Nav = () => {
    ...
    return (
        <div>
            <div className='w-full fixed top-0 left-0 bg-orange-400'>
                <div className='md:flex items-center justify-between py-0.5 bg-transparent md:px-10 px-7'>
                    ...
                    <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] px-6 right-0 w-half bg-orange-400 rounded-md  md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in-out ${open ? 'top-20': 'top-[-500px]'}`}>
                        {
                            Links.map((link) => (

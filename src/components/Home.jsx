...
export const Home = () => {
  return (
    <div
      name="home"
      className="h-screen w-full bg-gradient-to-b from-orange-300  to-orange-200"
    >
      <div className="gap-x-4 max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full md:flex-row">

...
export const Home = () => {
  return (
    <div
      name="home"
      className="h-screen w-full bg-gradient-to-b from-orange-400 via-orange-300 to-indigo-400"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full md:flex-row">
        <div className="flex flex-col justify-center ">
          ...
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gray-600 cursor-pointer"
            >
              Get Started
        ...
        <div>
          <img src={HeroImage}
            alt="my profile"
            className="rounded-2xl my-5 shadow-lg mx-auto w-2/3 md:w-full md:mx-8"
          />
        </div>
      </div>
    </div>
